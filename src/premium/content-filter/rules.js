...
(function () {
  ...
  "rules": [
    ...
    },
    {
      ...
      "type": "regex",
      "field": "content",
      "value": "(主页.{0,4}(打|看|来|约|玩)?.{0,4}✈️|打✈️|去.{0,4}主页.{0,4}(看|玩|约|找)|没人比.{0,4}(她)?.{0,4}(骚|sao)|比她.{0,4}(骚|sao).{0,4}(好|没她)|sao货|骚货|(太|真|很|超).{0,2}涩了|涩到顶不住|sao爆了|骚爆了|顶不住.{0,4}(她|想|要)|刷.{0,4}半天.{0,4}就她.{0,4}主页)",
      "severity": "high"
    },
    {
